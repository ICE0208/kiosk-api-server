...
export const readyPay = async (req, res) => {
  ...
  data.append("approval_url", "https://sm-kiosk.kro.kr/pay/success");
  data.append("cancel_url", "https://sm-kiosk.kro.kr/pay/cancel");
  data.append("fail_url", "https://sm-kiosk.kro.kr/pay/fali");
